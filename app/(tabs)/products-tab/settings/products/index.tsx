...
const Settigns = () => {
  ...
  return (
    ...
    >
      <HeaderEncrypted title="Configuración" iconBack={"/products-tab"} />
      <View style={styles.containerBody}>
        <SettingsMenuItem
          title={t(`${baseMsg}.language`)}
          value={t(`${baseMsg}.${currentLang}`)}
          path={"products-tab/settings/products/LaguageConf"}
        />
        {/* <SettingsMenuItem
          title={"Cambiar logo de APP"}
          path={"products-tab/settings/products/change-icon"}
        /> */}
      </View>
    </ScrollView>
  );
